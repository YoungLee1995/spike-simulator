...
// #define MATCH_SM_EXIT 0X40001033
// #define MASK_SM_EXIT 0XFE00707F
//MATCH
#define MATCH_SM_BARRIER      0X0000200B
#define MATCH_SM_DDEP_GEN     0X0000000B
#define MATCH_SM_DDEP_USE     0X0000400B
#define MATCH_SM_DDEP_RLS     0X0000100B

#define MATCH_SM_DMA_LS       0X4000000B
#define MATCH_SM_DMA_CP       0X4000100B

#define MATCH_SM_ROPE         0XC000000B
#define MATCH_SM_LAYERNORM    0XC000100B
#define MATCH_SM_RMSNORM      0XC000200B
#define MATCH_SM_SOFTMAX      0XC000300B
#define MATCH_SM_VEC_REDUCE   0XC000400B
#define MATCH_SM_VEC_SFU      0XC000500B
#define MATCH_SM_VEC_QUANTIZE 0XC000600B
#define MATCH_SM_VEC_ELEMWISE 0XC000700B

#define MATCH_SM_TENSOR       0X8000000B
#define MATCH_SM_CONV         0X8000100B
//MASK
#define MASK_SM_BARRIER       0XC000707F
#define MASK_SM_DDEP_GEN      0XC000707F
#define MASK_SM_DDEP_USE      0XC000707F
#define MASK_SM_DDEP_RLS      0XC000707F

#define MASK_SM_DMA_LS        0XC000707F
#define MASK_SM_DMA_CP        0XC000707F

#define MASK_SM_ROPE          0XC000707F
#define MASK_SM_LAYERNORM     0XC000707F
#define MASK_SM_RMSNORM       0XC000707F
#define MASK_SM_SOFTMAX       0XC000707F
#define MASK_SM_VEC_REDUCE    0XC000707F
#define MASK_SM_VEC_SFU       0XC000707F
#define MASK_SM_VEC_QUANTIZE  0XC000707F
#define MASK_SM_VEC_ELEMWISE  0XC000707F

#define MASK_SM_TENSOR        0XC000707F
#define MASK_SM_CONV          0XC000707F

#ifdef DECLARE_INSN
DECLARE_INSN(ism_barrier      , MATCH_SM_BARRIER       , MASK_SM_BARRIER       )
DECLARE_INSN(ism_ddep_gen     , MATCH_SM_DDEP_GEN      , MASK_SM_DDEP_GEN      )
DECLARE_INSN(ism_ddep_use     , MATCH_SM_DDEP_USE      , MASK_SM_DDEP_USE      )
DECLARE_INSN(ism_ddep_rls     , MATCH_SM_DDEP_RLS      , MASK_SM_DDEP_RLS      )
DECLARE_INSN(ism_dma_ls       , MATCH_SM_DMA_LS        , MASK_SM_DMA_LS        )
DECLARE_INSN(ism_dma_cp       , MATCH_SM_DMA_CP        , MASK_SM_DMA_CP        )
DECLARE_INSN(ism_rope         , MATCH_SM_ROPE          , MASK_SM_ROPE          )
DECLARE_INSN(ism_layernorm    , MATCH_SM_LAYERNORM     , MASK_SM_LAYERNORM     )
DECLARE_INSN(ism_rmsnorm      , MATCH_SM_RMSNORM       , MASK_SM_RMSNORM       )

DECLARE_INSN(ism_softmax      , MATCH_SM_SOFTMAX       , MASK_SM_SOFTMAX       )
